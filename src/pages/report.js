...
function Report(){
    ...
    return(
        ...
        <button2 className = {visible === 1? 'report-button active-btn' : 'report-button'} onClick = {onclick2}>report1</button2>
        
        <button2 className =  {visible === 2? 'report-button active-btn' : 'report-button'} onClick = {onclick3}>report2</button2>
